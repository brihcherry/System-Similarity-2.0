...
import { fetchInitialHeatmapFromReactor } from "../api/systemSimilarityApi-New";
import type { HeatmapMatrix } from "../types";
import { transformHeatmap } from "../utils/transformHeatmap-New";
 ...
 */
export function useHeatmapDataNew(): UseHeatmapDataResult {
